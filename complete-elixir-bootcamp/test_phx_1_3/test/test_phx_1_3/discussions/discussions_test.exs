defmodule TestPhx13.DiscussionsTest do
  use TestPhx13.DataCase

  alias TestPhx13.Discussions

  describe "topics" do
    alias TestPhx13.Discussions.Topic
  ...
  describe "comments" do
    alias TestPhx13.Discussions.Comment
