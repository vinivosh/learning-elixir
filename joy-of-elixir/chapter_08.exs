...
macguffin = String.trim(IO.gets("Insert the name for the important object to be sought out in the story: "))
IO.puts("In that faithful day, #{protag} proceeded into #{setting} with no knowledge that an epic quest for the #{macguffin} would be starting...")
